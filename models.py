...
class NearEarthObject:
    ...
    def __str__(self):
        ...
        if self.diameter =='nan' and self.hazardous==False:
            return f"A NearEarthObject {self.fullname} has an unknown diameter and is not potentially hazardous."
        elif self.diameter =='nan' and self.hazardous==True:
            return f"A NearEarthObject {self.fullname} has an unknown diameter and is potentially hazardous."
...
class CloseApproach:
    ...
    `NEODatabase` constructor.
    """
    def __init__(self, _designation = '', time= None, distance= 0.0, velocity= 0.0, **info):
